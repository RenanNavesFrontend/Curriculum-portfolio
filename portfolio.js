...
const texts = {
    en: {
        ...
        contact: "Contact",
        faq: "FAQ",
        faqP: "A FAQ page that provides quick answers to common questions, featuring an intuitive accordion-style interface. (There is no mobile version)",
        form: "Form",
        formP: "A form is an HTML element used to collect user input and submit data to a server for processing. (There is no mobile version)",
        ld: "Landing page",
        ldP: "A landing page is a single web page aimed at capturing leads or driving specific actions. (There is no mobile version)",
        tip: "Tip Calculator",
        tipP: "A tip calculator helps users determine the tip amount based on the bill total and chosen percentage. (There is no mobile version)",
        port: "Portfolio",
    ...
    pt: {
        ...
        faqP: "Uma página de FAQ que fornece respostas rápidas para perguntas comuns, com uma interface intuitiva em estilo acordeão. (Não há versão para celular)",
        form: "Formulário",
        formP: "Um formulário é um elemento HTML usado para coletar dados do usuário e enviar para processamento no servidor. (Não há versão para celular)",
        ld: "Página de Destino",
        ldP: "Uma página de destino é uma página web única destinada a captar leads ou impulsionar ações específicas. (Não há versão para celular)",
        tip: "Calculadora de Gorjeta",
        tipP: "Uma calculadora de gorjetas ajuda os usuários a determinar o valor da gorjeta com base no total da conta e na porcentagem escolhida. (Não há versão para celular)",
        port: "Portfólio",
